...
#EV2A epi Menstrual cycle#
pdf('EV2A, epi_menstrual_cycle.pdf',width=5.0,height=4)
...
pdf("EV2D, GSE203191.cilia.proportion.pdf",width = 3.5, height = 3)
...
pdf('EV2E, EPI_rmCilia_SULT1E1.pdf',width=4.8,height=4)
