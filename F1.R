...
pdf('F1E, all_locations.pdf',width=7,height=6)
...
saveRDS(epi_includeCilia,'../../EPI/include_cilia/include_EC/epi_includeCilia.rds')
remove(epi_includeCilia)

str_includeOV<-subset(all,cell_type=='Stromal fibroblasts')
saveRDS(str_includeOV,'../../STR/include_ov/str_includeOV.rds')
remove(str_includeOV)
